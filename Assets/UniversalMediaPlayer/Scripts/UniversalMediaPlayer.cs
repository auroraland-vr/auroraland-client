...
#region Editor Additional Possibility
    ...
    private IEnumerator VideoPathPreparing(string path, bool playImmediately, IPathPreparedListener listener)
    {
        ...
        if (_videoHostingParser.IsVideoHostingUrl(path))
        {
            ...
            var videoInfo = _videoHostingParser.GetBestQualityVideo(videoInfos, 2160);// _videoHostingParser.GetBestCompatibleVideo(videoInfos);//_videoHostingParser.GetBestQualityVideo(videoInfos, 2160);
