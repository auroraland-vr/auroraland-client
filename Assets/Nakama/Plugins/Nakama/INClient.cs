...
namespace Nakama
{
    public interface INClient
    {
        ...
        Action<INSpacePresence> OnSpacePresence { get; set; }

        Action<INNotification> OnNotification { get; set; }

        Action<INEvent> OnEvent { get; set; }

        Action<INEvent> OnAuthoritateEvent { get; set; }

        Action<INControlData> OnControlData { get; set; }
