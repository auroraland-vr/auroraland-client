...
namespace Auroraland{
	...
	/// </summary>
	[SDK_Description(typeof(NonVRSimSystem))]
	public class NonVRSimController: SDK_BaseController {
		protected NonVRControllerSimulator rightController;
		protected NonVRControllerSimulator leftController;
		...
		{
			return ControllerType.Custom; //TODO add custom controller hand type
		}
		...
		{
			return "ControllerColliders/Simulator"; //TODO?
		}
		...
		public override GameObject GetControllerModel(ControllerHand hand)
		{
			...
			GameObject simPlayer = NonVRInputSimulator.FindInScene();
			if (simPlayer != null)
			{
				switch (hand)
				{
		...
		protected virtual void SetupPlayer()
		{
			if (rightController == null || leftController == null)
			{
				...
				if (simPlayer != null)
				{
					rightController = (rightController == null ? simPlayer.transform.Find(RIGHT_HAND_CONTROLLER_NAME).GetComponent<NonVRControllerSimulator>() : rightController);
					leftController = (leftController == null ? simPlayer.transform.Find(LEFT_HAND_CONTROLLER_NAME).GetComponent<NonVRControllerSimulator>() : leftController);
				}
			}
		}
