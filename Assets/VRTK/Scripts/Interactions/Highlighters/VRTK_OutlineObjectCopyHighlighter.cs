...
namespace VRTK.Highlighters
{
    ...
    {
        [Tooltip("The seethruough of the highlight effect")]
        public float seethru = 0f; // by auroraland
        [Tooltip("The darken of the highlight effect")]
        public float darken = 0f; // by auroraland
        ...
        public override void Initialise(Color? color = null, Dictionary<string, object> options = null)
        {
            ...
            {
                stencilOutline = Instantiate((Material)Resources.Load("OutlineBasic")); //vrtk is using Outline Basic shader
            }
            SetOptions(options);
            ResetHighlighter();
        }
        ...
        public override void Highlight(Color? color, float duration = 0f)
        {
            ...
            {
                stencilOutline.SetColor("_TintColor", (Color)color);  //vrtk is using Outline Basic shader
                stencilOutline.SetFloat("_SeeThru", seethru);
                stencilOutline.SetFloat("_Darken", darken);
                //stencilOutline.SetFloat("_Outline", thickness);  //vrtk is using Outline Basic shader
