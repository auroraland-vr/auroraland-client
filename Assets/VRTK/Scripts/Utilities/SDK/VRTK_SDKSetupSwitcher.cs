...
namespace VRTK
{
    ...
    public class VRTK_SDKSetupSwitcher : MonoBehaviour
    {
        ...
        protected virtual void Show(ViewingState viewingState)
        {
            ...
            eventSystem.gameObject.SetActive((EventSystem.current == null || EventSystem.current == eventSystem)); // this help getting the correct overlapping ui, but you will need 2 eventsystem in the scene
        }
